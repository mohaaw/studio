                        ...
                        <CardHeader>
                            <div className="flex flex-col md:flex-row gap-4 justify-between">
                                <div className="relative flex-1">
                                    ...
                                    <Input placeholder={t('search.placeholder')} className="h-12 text-lg pl-12" />
                                </div>
                                <Dialog>
                                    <DialogTrigger asChild>
                                        <Button variant="outline" className="h-12"><ScanLine className="mr-2 h-6 w-6" /> {t('buttons.scan')}</Button>
                                    </DialogTrigger>
                    ...
                    <Card className="h-full flex flex-col bg-card">
                        <CardHeader>
                            ...
                            <div className="flex items-center justify-between pt-2">
                                {activeCustomer ? (
                                    ...
                                    <Button variant="outline" size="sm" onClick={() => setCustomerModalOpen(true)}><UserPlus className="mr-2 h-4 w-4"/>{t('buttons.addCustomer')}</Button>
                                )}
                        ...
                        <CardFooter className="flex-col !p-4 border-t mt-auto">
                            ...
                            <div className="grid grid-cols-2 gap-2 w-full mt-4">
                                <Button variant="outline" onClick={() => setPromotionsModalOpen(true)}><Gift className="mr-2 h-4 w-4" /> {t('buttons.promotions')}</Button>
                                <Button size="lg" className="h-12 text-lg font-bold" onClick={() => setPaymentOpen(true)}><CreditCard className="mr-2 h-6 w-6" />{t('buttons.pay')}</Button>
                            </div>
                            <Button variant="destructive" size="sm" className="w-full mt-2" onClick={handleClearCart}><Trash2 className="mr-2 h-4 w-4" />{t('buttons.clearCart')}</Button>
                        </CardFooter>
                        }
                    </Card>
                </div>
